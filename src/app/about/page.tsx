...
export default function About() {
  ...
  return (
    <motion.div
      className="bg-background w-full h-[90vh]"
      initial="hidden"
      animate="visible"
      variants={fadeInVariant}
    >
      <MaxWidthWrapper className="pb-10">
        <h1 className="text-4xl font-bold text-center mb-10 mt-4 md:mt-10">
          About
        </h1>
        <AboutSection />
        ...
        <h1 className="text-4xl font-bold text-center mb-4 mt-10">Education</h1>
        <Education />
